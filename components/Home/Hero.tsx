...
const Hero = (props: {}): JSX.Element => {
    ...
    return <div className='container mx-auto px-4 lg:px-0 pb-20 pt-28 md:pt-36'>
        ...
        <div className='flex flex-col items-center justify-center gap-6 sm:gap-8 lg:gap-10 text-center'>
            ...
            <p className='text-lg md:text-xl max-w-4xl 2xl:max-w-5xl text-gray-800 dark:text-gray-300'>Welcome to Govsites! It's a simple collection of <span className='font-bold'> Australian government's</span> websites, apps, services and tools available to every day Australians. This site only contains links to authentic Australian government sites and services.</p>
